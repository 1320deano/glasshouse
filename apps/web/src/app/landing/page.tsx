...
import { CONNECT_COMMAND, PRODUCT_NAME, SHED_NAME, SITE_NAME } from "@/lib/brand";
...
export default async function LandingPage() {
  ...
  return <Landing frames={frames} suggestions={suggestions} siteName={SITE_NAME} productName={PRODUCT_NAME} shedName={SHED_NAME} priceGbp={PRO_PRICE_GBP} local={getStore().mode === "local"} connectCommand={CONNECT_COMMAND} />;
}
