...
- Three columns (Phase 5): agents on the left, the running story in the middle, progress on the right.
  ...
  width is dragged from its inner edge; cards have a compact density and each progress section folds. Every
  fold and width is remembered in the browser only.
